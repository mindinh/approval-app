...
export function FilterBar({
    ...
    return (
        <>
            <div
                className={`bg-card rounded-xl border border-border hover:border-primary/40 transition-all shadow-sm ${className}`}
                ...
                <div className={`flex items-center gap-2 sm:gap-3 px-4 py-2 ${isExpanded ? 'border-b border-border/60' : ''}`}>
                    ...
                    <div className={`flex flex-wrap items-center gap-1.5 sm:gap-2 ${!headerLeft ? 'ml-auto' : ''}`}>
                        ...
                        <Button
                            onClick={handleApply}
                            variant="default"
                            className="min-w-0 sm:min-w-16 px-2.5 sm:px-3"
                        >
                            Go
                        </Button>
