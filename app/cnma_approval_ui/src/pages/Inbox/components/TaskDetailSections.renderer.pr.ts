            ...
            cards: [
                {
                    ...
                    fields: [
                        ...
                        field('PR Type', mergeCodeName(header?.purchaseRequisitionType, header?.purchaseRequisitionTypeText || prFacts?.items?.[0]?.purchaseRequisitionTypeText)),
    ...
    return {
        ...
        rows: (prFacts?.items || []).map((item) => ({
            ...
            values: {
                ...
                costCenter: item.costCenter ? mergeCodeName(item.costCenter, item.costCenterDescription) : undefined,
            },
        })),
