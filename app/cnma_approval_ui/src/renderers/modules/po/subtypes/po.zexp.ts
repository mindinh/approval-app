...
export function buildPoZexpItemsTable(rawItems?: any[], parentCurrency?: string): DetailTableModel | null {
    ...
    const rows: DetailTableRow[] = rawItems.map((item, idx) => {
        ...
        return {
            ...
            values: {
                ...
                fundsCenter: formatCodeWithText(item.fundsCenter || item.department, item.fundsCenterName || item.fundsCenterText),
