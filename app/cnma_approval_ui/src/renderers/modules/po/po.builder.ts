...
export function buildPoModel(detail: TaskDetail): BusinessSectionModel {
    ...
    const docType = (detail.documentType || detail.header?.purchaseOrderType || '').toUpperCase();
    ...
    const rawDocTypeDisplay = detail.documentTypeDisplay || detail.header?.purchaseOrderTypeText;
